    ...
    <div>
      <div className='pt-12 px-12 lg:px-80 justify-items-center md:px-40'>
        <div className='flex justify-between align-center'>
          ...
          <div>
          <Link className='px-4' href={`../../edit/${result._id}`}>수정</Link>
            <DeleteBtn deleteId={props.params.id}  />
            </div>
        </div>
        <div className='border-b border-gray-900/10 pb-12'>
          <div className='flex justify-between align-center border-b border-gray-500 pb-6'>
            <p className='mt-1 text-sm leading-6 text-gray-600 '>by  <span className='text-lg font-semibold text-black'>{result.writer}</span> </p>
