      ...
      <body className={inter.className}>
        <nav className=' flex justify-between p-6 lg:px-8' aria-label='Global'>
          ...
          <div className='hidden lg:flex lg:gap-x-12'>
            ...
            {session ? (
              <Link href={'/write'} className='text-sm font-semibold leading-6 text-gray-900'>
                write
              </Link>
            ) : (
              ''
          ...
          <div className='hidden lg:flex lg:flex-1 lg:justify-end'>
            {session ? (
              ...
              <span>
                <Link href='/register' className='font-semibold mr-4'>
                  Register
                </Link>
                <LoginBtn />
              </span>
        ...
        <footer className='flex flex-col items-center bg-yellow-800 text-center text-white '>
          ...
          <div className='w-full bg-yellow-900 p-4 text-center text-neutral-700 dark:text-neutral-200'>
            © 2023 Copyright:
